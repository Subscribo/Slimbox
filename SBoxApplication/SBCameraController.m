...
NSString *const SBCameraErrorDomain = @"SBCameraErrorDomain";

@implementation SBCameraController
    ...
    if ([AVCaptureDevice respondsToSelector:@selector(requestAccessForMediaType: completionHandler:)]) {
        [AVCaptureDevice requestAccessForMediaType:AVMediaTypeVideo completionHandler:^(BOOL granted) {
            if (granted) {
                ...
                NSError *error = [NSError errorWithDomain:SBCameraErrorDomain
                                                 code:SBCameraErrorCodePermission
                                             userInfo:nil];
